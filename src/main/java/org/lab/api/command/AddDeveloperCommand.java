...
public final class AddDeveloperCommand implements AuthorizedDataCommand<Void> {
    ...
    public Void execute(DatabaseProvider databaseProvider, AuthorizationProvider authorizationProvider) {
        ...
        databaseProvider.getProjectUserRepository().addUserToProject(new ProjectUser(projectId, user, ProjectRole.DEVELOPER, true));
        return null;
    }
}
